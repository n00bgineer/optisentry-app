...
const LandingPage = () => {
  ...
  return (
    <>
      <MetaTags
        title="Home"
        description="Track your application's performance effortlessly with OptiSentry"
      />
      <>
        <Header />
          ...
          >
            <AddressBar elevation={0}>
              <Https
                ...
                color="success"
              />
              <Typography variant="body2">optisentry.com</Typography>
            </AddressBar>
            <img
              src={
                isDarkMode
        ...
        <Box id="features" component="section">
          <Box className="section-title-container">
            <Typography variant="h2" className="section-title">
              Enhance your app&rsquo;s performance with OptiSentry
            </Typography>
          ...
          <Box className="features-card-container card-container">
            <FeaturesCard
              ...
              content="OptiSentry shows performance reports with simplifies metrics & deep dives for effortless optimization and makes it accessible to even non-technical stakeholders to analyze and improve performance indicators with ease."
            ...
            <FeaturesCard
              ...
              content="OptiSentry visualizes the routing path of your network packets along with it's geographic location & does IP threat intelligence to look for malicious IP addresses from hops"
            ...
            <FeaturesCard
              ...
              content="OptiSentry currently offers report generations on non-authenticated routes, but the authenticated routes feature will allow to generate performance reports even on pages which requires authentication for access"
            ...
            <FeaturesCard
              ...
              content="OptiSentry's competitor analysis feature, allows you to compare your product's performance metrics against industry rivals. Gain valuable insights & surpass the competition"
            ...
            <FeaturesCard
              ...
              content="OptiSentry tracks performance metrics across multiple applications. Gain comprehensive insights into the performance of each app and optimize their performance"
        ...
        <Box id="pricing" component="section">
          <Box className="section-title-container">
            ...
            >
              A no-nonsense guide to OptiSentry&rsquo;s pricing. Only{' '}
        ...
        <Box id="faq" component="section">
          ...
          <Box className="faq-card-container card-container">
            <FaqCard
              question="What is OptiSentry?"
              answer="OptiSentry is an application performance and security monitoring system that generates reports with security tracerouting and simplified performance metrics to help optimize application performance"
            />
            <FaqCard
              question="How does OptiSentry help improve application performance?"
              answer="OptiSentry enables users to track and analyze performance metrics, identify bottlenecks, and optimize their applications for seamless user experiences"
            />
            <FaqCard
              question="Can OptiSentry monitor applications from multiple locations?"
              answer="Yes, OptiSentry generates performance reports from multiple locations across the globe, offering insights into how an application performs in different geographical locations"
            />
            <FaqCard
              question="Is OptiSentry's reports suitable to be used by non-technical stackeholders?"
              answer="Absolutely! OptiSentry offers a user-friendly interface and simplified metrics, making it accessible and easy to use for both technical and non-technical users"
            />
            <FaqCard
              question="Can I compare my application's performance against competitors using OptiSentry?"
              answer="It's WIP, but OptiSentry provides a competitor analysis feature that allows you to compare your application's performance metrics against industry rivals, giving you insights to outperform the competition"
            />
            <FaqCard
              question="Can OptiSentry generate performance reports fpr native mobile applications (e.g. React Native, etc)?"
          ...
          <Box className="cta-content-container">
            <Box className="section-title-container">
              ...
              <Typography variant="body1" className="section-subtitle">
                ...
                OptiSentry. Start your monitoring journey today on our platform
              </Typography>
              <Box className="hero-cta-container">
                <Button
                  variant="contained"
